      ...
      <div className="w-full max-w-md space-y-8 bg-white p-8 rounded-xl shadow-sm">
        <div>
          <h2 className="mt-6 text-center text-3xl font-bold tracking-tight text-slate-900">
            Sign in to TradersPro
          </h2>
          <p className="mt-2 text-center text-sm text-slate-600">
            Hardware & Metal Trading Business Management
          </p>
        </div>
        ...
        <div className="text-center text-sm">
          <Link href="/register" className="font-medium text-slate-600 hover:text-primary">
            Don't have an account? Start 14-day free trial
          </Link>
        </div>
      </div>
    </div>
